...
export const Adddoctor = () => {
  ...
  return (
    <Navbar>
        <h2 style={{marginTop:"20px",textAlign:"center"}} className='heading'>Add Doctor</h2>
        <div className="add-doctor">
            <div className='left-det'>
                <div style={{display:"inline"}}>
                    <div id="fname" style={{marginLeft: "30%"}} className="required formerror"></div>
            ...
            <div className='right-det'>
                <div style={{display:"inline"}}>
                    <div id="fdob" style={{marginLeft: "50%"}} className="required formerror"></div>
                    <Calendar style={{marginTop:"0%", marginBottom: "2%"}} value={docdetails.docdob} onChange={handleChange} name='docdob' placeholder='select DOB' required/>
                </div>
                <div style={{display:"inline"}}>
                    <div id="fpass" style={{marginLeft: "50%"}} className="required formerror"></div>
                    <Password style={{margin:"5% 3% 5% 3%", }} value={docdetails.docpass} onChange={handleChange} header={header} footer={footer} placeholder='Enter Password'  name='docpass' toggleMask required/>    
                </div>
                <div style={{display:"inline"}}>
                    <div id="fgender" style={{marginLeft: "50%"}} className="required formerror"></div>
                    <Dropdown style={{marginBottom: "5%"}} value={docdetails.docgender} onChange={handleChange} options={gender} optionLabel="label"  name='docgender'
                        placeholder="Select Gender" className="w-full md:w-14rem" required/>    
                </div>
                <div style={{display:"inline"}}>
                    <div id="fdept" style={{marginLeft: "50%"}} className="required formerror"></div>
                    <Dropdown style={{marginBottom: "7%"}} value={docdetails.docdept} onChange={handleChange} options={departments} optionLabel=""  name='docdept'
                        placeholder="Select the Department" className="w-full md:w-14rem" required/>    
                </div>
                <div style={{display:"inline"}}>
                    <div id="fexp" style={{marginLeft: "50%"}} className="required formerror"></div>
                    <span className="p-float-label" style={{marginLeft: "3%", marginBottom: "10%"}}>
